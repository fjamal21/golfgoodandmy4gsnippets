...
class Config
{
     ...
     */
    private $site_name = 'Golf for Good';
    private $url = 'admin.golf4good.golf';
    private $site_url = 'golf4good.golf';
    private $secure_url = 'http://golf4good.golf';
    private $site_email = 'admin@golf4good.ca';
    private $error_email = 'admin@golf4good.ca';
     ...
     * Event dates
     */
    private $start_date = '07/18/2016';
    private $end_date = '08/18/2016';
    /*
     * Stripe keys
     */
